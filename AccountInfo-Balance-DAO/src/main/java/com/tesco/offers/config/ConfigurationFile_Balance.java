...
@ComponentScan(basePackages={"com.tesco.offers.account.balances.dao","com.tesco.offers.account.balance.dao.implementation"})
/*@EnableTransactionManagementcom.tesco.offers.account
*/
public class ConfigurationFile_Balance {
