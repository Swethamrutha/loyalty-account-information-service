 ...
 */
public class PureHibernateFeatureDaoImplementation implements FeaturesDao {
	...
	//System.out.println("Request Completed");
	PureHibernateFeatureDaoImplementation hibernateChecking=new  PureHibernateFeatureDaoImplementation();
